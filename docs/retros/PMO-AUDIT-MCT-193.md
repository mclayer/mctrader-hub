...
verified_sources:
  ...
  - "hub#387 (3d79e1e PR-1 docs) + hub#TBD (PR-2 alert/cron/박제)"
...
| PR | **2 single-repo sequential** (PR-1 hub#387 3d79e1e docs → PR-2 hub#TBD alert/cron/박제 통합) |
...
| 2 | mctrader-hub PR-2 alert/cron/박제 | #TBD-post-merge | TBD | prometheus-alerts.yml `evidence-quad-enforcement` group (ADR-029/030 2 alert) + quad-evidence-audit.yml repo 최초 cron + ADR-033 §6 VERIFIED 확정 + frontmatter Proposed → Accepted + §9.2 VERIFIED + Story §8.5/§11 실 PR#/sha + COMPLETED + counters COMPLETED + EPIC POLICY_FINALIZED + RETRO-MCT-193 + 본 PMO-AUDIT-MCT-193 + EPIC-RESULTS §Story-3 (milestone 3/3) + §3.5 PR-3 #TBD→#385 carry 정정 + CLAUDE.md §EPIC 2/3→3/3 |
...
| 3 | **MCT-193** | **운영 (verify gate)** | ADR-029/030 quad violation alert (`absent() or increase([14d])==0` critical) + repo 최초 cron (gh issue) + ADR-031 alert 제외 caveat + ADR-033 Accepted | ✅ single-repo LAND (hub#387 + hub#TBD) |
...
| 3 | **MCT-193** | **COMPLETED 2026-05-17** | post-LAND verify gate 운영 (quad violation alert + repo 최초 cron + ADR-033 Accepted) | hub#387 + hub#TBD LAND. deviation 0 (8/8), FIX 0회 |
...
mctrader-hub MCT-193 LAND (hub#387 + hub#TBD, 2026-05-17). #822 self-discipline gate v1
...
- 2 PR LAND: hub#387 (3d79e1e PR-1 docs) + hub#TBD (PR-2 alert/cron/박제 — counters COMPLETED + ADR-033 Accepted + EPIC POLICY_FINALIZED 3/3 + 본 PMO-AUDIT)
