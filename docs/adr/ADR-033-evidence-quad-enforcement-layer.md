...
- **§9.2 sub-3 (MCT-193) — draft (PR-1 docs LAND)**: PR-1 docs LAND (§6.1 amendment box
  draft + §4 R-1 SSOT drift caveat + scope_manifest mct_193_* 6 블록). PR-2 alert/cron
  LAND 후 §6 VERIFIED 확정 + frontmatter Proposed → Accepted + §9.2 VERIFIED 2026-05-17.
